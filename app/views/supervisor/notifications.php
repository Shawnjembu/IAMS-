        ...
        <?php else: ?>
            <div class="list-group">
                <?php foreach ($notifications as $notif): ?>
                    ...
                    ?>
                    <div class="list-group-item <?php echo !$notif['is_read'] ? 'list-group-item-light border-start border-info border-3' : ''; ?>">
                        <div class="d-flex w-100 justify-content-between align-items-start">
                            ...
                            <?php if (!$notif['is_read']): ?>
                                <form method="POST" action="<?php echo BASE_URL; ?>supervisor/mark-notification-read" class="ms-3">
